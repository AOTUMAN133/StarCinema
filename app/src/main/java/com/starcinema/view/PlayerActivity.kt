...
import com.starcinema.api.EmbyMediaSource
import com.starcinema.api.EmbyPerson
import com.starcinema.app.PreferencesHelper
import com.starcinema.danmu.DanmuApiClient
import com.starcinema.danmu.DanmuItem
import com.starcinema.danmu.DanmuSearchPanel
import com.starcinema.danmu.DanmakuManager
import com.starcinema.player.PlayerViewModel
...
import com.starcinema.player.surface.MpvOsdSurfaceView
import com.starcinema.player.surface.RenderSurfaceView
...
class PlayerActivity : ComponentActivity() {
    ...
    private fun switchKernel() {
        ...
        try {
            ...
            try {
                com.starcinema.player.kernel.VideoLog.e("switchKernel LinkageError: ${e.message}", e)
            } catch (_: Exception) {}
