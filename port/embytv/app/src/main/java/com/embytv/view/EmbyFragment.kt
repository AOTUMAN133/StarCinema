...
import com.embytv.api.EmbyLibrary
import com.embytv.app.PreferencesHelper
import com.embytv.databinding.FragmentEmbyBinding
import com.embytv.model.VideoType
...
class EmbyFragment : Fragment() {
    ...
    private fun retryFocus(row: Int, item: Int, attempt: Int) {
        ...
        val videoList = vh.itemView.findViewById<com.rubensousa.dpadrecyclerview.DpadRecyclerView>(com.embytv.R.id.videoList)
